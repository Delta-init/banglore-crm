...
public final class FragmentRecentCallsBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static FragmentRecentCallsBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentRecentCallsBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_recent_calls, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentRecentCallsBinding bind(@NonNull View rootView) {
