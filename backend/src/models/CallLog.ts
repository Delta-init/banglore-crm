...
export interface ICallLog {
  ...
  source:         "3cx_journal" | "click_to_call" | "manual" | "call_recorder_app";
...
const callLogSchema = new Schema<ICallLog>(
  {
    ...
    source:         { type: String, enum: ["3cx_journal", "click_to_call", "manual", "call_recorder_app"], default: "3cx_journal" },
